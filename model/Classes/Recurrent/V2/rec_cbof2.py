...
class LSTM_CBOW(object):
    ...
    """
    def __init__(
      self, input_x, input_y, num_batches_per_epoch,
      sequence_length, num_classes, vocab_size, max_grad_norm, batch_size, dropout_keep_prob,
      embedding_size, n_hidden, n_layers, l2_reg_lambda=0.0):
        ...
        with tf.device('/cpu:0'):
          ...
          "embedding", [vocab_size, embedding_size], dtype=tf.float32)
            embedded_chars = tf.nn.embedding_lookup(embedding, self.input_x)
